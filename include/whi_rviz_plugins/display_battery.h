...
namespace whi_rviz_plugins
{
	...
	// declare our new subclass of rviz::Display. Every display
	// which can be listed in the "Displays" panel is a subclass of
	// rviz::Display
	//
	// DisplayBat will show a movable_text showing the power info of battery
	// it will also optionally show a history of recent
	// info vectors, which will be stored in a circular buffer
	//
	// the DisplayBat class itself just implements the circular buffer,
	...
	public:
		...
		// as much as possible, when Displays are not enabled, they should not be
		// subscribed to incoming data and should not show anything in the 3D view
