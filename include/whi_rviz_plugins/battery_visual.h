...
namespace whi_rviz_plugins
{
	...
	public:
		...
		void setMessage(const whi_interfaces::msg::WhiBattery::ConstSharedPtr Msg);
	...
	private:
		...
		std::shared_ptr<rviz_rendering::MovableText> battery_info_{ nullptr };
		// the object of battery shape
		std::vector<std::shared_ptr<rviz_rendering::Shape>> battery_shape_;
