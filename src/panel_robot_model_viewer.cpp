...
{
    RobotModelViewerPanel::RobotModelViewerPanel(rviz_common::DisplayContext* DisplayContext, Ogre::SceneNode* SceneNode,
        QWidget* Parent/* = nullptr*/)
        : display_context_(DisplayContext), scene_node_(SceneNode), QWidget(Parent), ui_(new Ui::NaviRobotModelViewer())
	{
		// set up the GUI
		ui_->setupUi(this);
