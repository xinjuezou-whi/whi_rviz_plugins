...
namespace whi_rviz_plugins
{
        ...
        : Display()
    {
        ...
        data_size_property_ = new rviz_common::properties::FloatProperty("Data size", 2.0, "Data grid size",
            this, SLOT(updateGridDataSize()));
        data_color_property_ = new rviz_common::properties::ColorProperty("Data grid color", Qt::yellow, "Data grid color.",
            this, SLOT(updateDataColor()));
        grid_major_size_property_ = new rviz_common::properties::FloatProperty("Major grid size", 0.5, "Major grid size",
            this, SLOT(updateGridMajorSize()));
        grid_major_color_property_ = new rviz_common::properties::ColorProperty("Major grid color", Qt::cyan,
            "Major grid color.", this, SLOT(updateMajorColor()));
        grid_minor_size_property_ = new rviz_common::properties::FloatProperty("Minor grid size", 0.2, "Minor grid size",
            this, SLOT(updateGridMinorSize()));
        grid_minor_color_property_ = new rviz_common::properties::ColorProperty("Minor grid color", Qt::gray,
            "Minor grid color.", this, SLOT(updateMinorColor()));
        canvas_color_property_ = new rviz_common::properties::ColorProperty("Canvas color", QColor(38, 64, 115),
            "Canvas grid color.", this, SLOT(updateCanvasColor()));
    }
...
PLUGINLIB_EXPORT_CLASS(whi_rviz_plugins::Display2DLineChart, rviz_common::Display)
