...
namespace whi_rviz_plugins
{
    ...
    {
        sub_charging_state_ = node_handle_->create_subscription<std_msgs::msg::String>(
    ...
    void BatteryPanel::subCallbackChargingState(const std_msgs::msg::String::SharedPtr Msg)
    {
